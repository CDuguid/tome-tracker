...
class TestListBooksInDB:
    def test_returns_list_of_all_book_titles_in_db(
        self, meditations_info, circe_info, time_and_chance_info
    ):
        create_books_table("test_tome_tracker")
        add_book_to_db("test_tome_tracker", meditations_info, True)
    ...
    def test_returns_list_of_all_read_books(
        self, meditations_info, circe_info, time_and_chance_info
    ):
        create_books_table("test_tome_tracker")
        add_book_to_db("test_tome_tracker", meditations_info, True)
    ...
    def test_returns_list_of_all_unread_books(
        self, meditations_info, circe_info, time_and_chance_info
    ):
        create_books_table("test_tome_tracker")
        add_book_to_db("test_tome_tracker", meditations_info, True)
...
class TestCheckIfBookInDB:
    def test_returns_true_if_book_is_in_database(self, meditations_info):
        create_books_table("test_tome_tracker")
        add_book_to_db("test_tome_tracker", meditations_info, True)
        assert check_if_book_in_db("test_tome_tracker", meditations_info["id"])

    def test_returns_false_if_book_is_not_in_database(self, meditations_info):
        create_books_table("test_tome_tracker")
        assert not check_if_book_in_db("test_tome_tracker", meditations_info["id"])
...
class TestUpdateBookInDB:
    ...
    def test_does_nothing_if_attempting_to_update_a_nonpresent_book(
        self, meditations_info, circe_info
    ):
        create_books_table("test_tome_tracker")
        add_book_to_db("test_tome_tracker", circe_info, True)
        update_book_in_db("test_tome_tracker", meditations_info["title"], True)
